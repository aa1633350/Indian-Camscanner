...
public class PolygonView extends FrameLayout {
    ...
    public PolygonView(Context context, AttributeSet attrs, int defStyleAttr) { // constructor
    ...
    private void init() {
        polygonView = this;
        pointer1 = getImageView(0, 0); //sets the pointer to upper left hand corner
        pointer2 = getImageView(getWidth(), 0); //sets to upper right corner
        pointer3 = getImageView(0, getHeight()); //sets to bottom left
        pointer4 = getImageView(getWidth(), getHeight()); //sets to bottom right
    ...
    public Map<Integer, PointF> getPoints() { //PointF is a class and holds two float coordinates cant be null

        List<PointF> points = new ArrayList<PointF>();
        points.add(new PointF(pointer1.getX(), pointer1.getY())); //adding the two coordinates to PointF
    ...
    public Map<Integer, PointF> getOrderedPoints(List<PointF> points) {
        ...
        PointF centerPoint = new PointF(); //centerPoint has two coordinates points is the Array List here
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        //Draw a line segment with the specified start and stop x,y coordinates, using the specified color.
